...
Public Sub m_TrimTrailingDecorations(ByRef targetRange As Range)
    mp_TrimTrailingDecorations targetRange
End Sub
...
Public Function m_InflectPhraseByDashSegmentsToCase(ByVal phraseText As String, ByVal targetCase As String, ByVal maxWordsPerSegment As Long) As String
    ...
    If caseName <> "genitive" And caseName <> "accusative" Then Exit Function
