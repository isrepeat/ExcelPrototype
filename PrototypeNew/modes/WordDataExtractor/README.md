...
запятую, могут иметь собственные даты. Номер извлекается целиком между
`№`/`№№` и маркером `від <дата>`, поэтому внутри него допустимы, например,
буквенные сегменты `1848/вд/1528`.
