...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "obj_PageComparing"
Option Explicit
...
Private Const SERIALIZABLE_TYPE_ROOT As String = "page.comparing"
...
Private Const PAGE_RUNTIME_OBJECT_KEY As String = "RuntimeObjects.PageComparing"

Private m_PageBase As obj_PageBase
Private m_Controller As obj_PageComparingCtrl
...
#End If
    ...
    Set m_Controller = New obj_PageComparingCtrl
...
#If LOGGING_DEBUG_ENABLED Then
    ex_Core.fn_Diagnostic_LogInfo "enter:obj_PageComparing.RunPagePipeline"
#End If
...
Private Function obj_IPage_UpdateUiPath( _
    ...
    If VBA.Len(normalizedReason) = 0 Then normalizedReason = "obj_PageComparing.UpdateUiPath"
