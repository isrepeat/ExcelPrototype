...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "obj_PageMultiSourcesView"
Option Explicit
...
Private Const SERIALIZABLE_TYPE_ROOT As String = "page.multisourcesview"
...
Private Const PAGE_RUNTIME_OBJECT_KEY As String = "RuntimeObjects.MultiSourcesView"

Private m_PageBase As obj_PageBase
Private m_Controller As obj_PageMultiSourcesViewCtrl
...
#If LOGGING_DEBUG_ENABLED Then
        ex_Core.fn_Diagnostic_LogError "PageComparing.Initialize: parent page is not specified in context."
#End If
        Exit Function
    End If
    ...
    Set m_Controller = New obj_PageMultiSourcesViewCtrl
...
#If LOGGING_DEBUG_ENABLED Then
    ex_Core.fn_Diagnostic_LogInfo "enter:obj_PageMultiSourcesView.RunPagePipeline"
#End If
...
Private Function obj_IPage_UpdateUiPath( _
    ...
    If VBA.Len(normalizedReason) = 0 Then normalizedReason = "obj_PageMultiSourcesView.UpdateUiPath"
...
Public Function OnRunPipelineAndRenderCommand(Optional ByVal arg As Variant) As Boolean
    If m_Controller Is Nothing Then Exit Function
    OnRunPipelineAndRenderCommand = m_Controller.RunPipeline(True)
End Function

Public Function OnRenderCommand(Optional ByVal arg As Variant) As Boolean
    If m_Controller Is Nothing Then Exit Function
    OnRenderCommand = m_Controller.RerenderPage(True)
End Function
