...
Private Function private_GetKnownSectionCaptionByText(ByVal valueText As String) As String
    ...
    Select Case normalizedText
        ...
        Case "щорічна відпустка => сімейна відпустка"
            private_GetKnownSectionCaptionByText = "Щорічна відпустка / Сімейна відпустка:"
        Case "сімейна відпустка => щорічна відпустка"
            private_GetKnownSectionCaptionByText = "Сімейна відпустка / Щорічна відпустка:"
