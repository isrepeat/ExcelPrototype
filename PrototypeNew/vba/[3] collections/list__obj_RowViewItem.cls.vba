...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "list__obj_RowViewItem"
Option Explicit
...
Public Function Add(ByVal item As obj_RowViewItem) As Boolean

    m_ObjectCollectionBase.AddObject item
    Add = True
End Function

Public Property Get Item(ByVal oneBasedIndex As Long) As obj_RowViewItem
